function preprocess_nsd(sessix)
...
figuredir = [ppdir '/preprocessVER1figures'];
...
wantpushalt = [];
%%wantpushalt = [ppdir '/preprocessfigures/record.mat'];
...
savefile = [ppdir '/preprocessVER1/run%02d.nii'];
savefileB = [ppdir '/preprocessVER1/valid.nii'];
savefileC = [ppdir '/preprocessVER1/mean.nii'];
savefileD = [ppdir '/preprocessVER1/mad.nii'];
savefileE = [ppdir '/preprocessVER1/tsnr.nii'];

% what .txt file should we keep a diary in?
diaryfile = [ppdir '/preprocessVER1/diary.txt'];
