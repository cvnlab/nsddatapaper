function preprocess_nsd_secondstage(sessix)
...
figuredir = [ppdir '/preprocessVER1SECONDSTAGEfigures'];
...
episliceorder{2} = epitrtweaks{sessix};
...
% construct coordinates desired in the final space (1-mm separation)
...
savefile = [ppdir '/preprocessVER1SECONDSTAGE/run%02d.nii'];
savefileB = [ppdir '/preprocessVER1SECONDSTAGE/valid.nii'];
savefileC = [ppdir '/preprocessVER1SECONDSTAGE/mean.nii'];
savefileD = [ppdir '/preprocessVER1SECONDSTAGE/mad.nii'];
savefileE = [ppdir '/preprocessVER1SECONDSTAGE/tsnr.nii'];

% what .txt file should we keep a diary in?
diaryfile = [ppdir '/preprocessVER1SECONDSTAGE/diary.txt'];
